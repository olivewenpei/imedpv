...
/**
 * SdSectionValuesFixture
 *
 */
class SdSectionValuesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'case_no' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'version_no' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'sd_section_structure_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'case_index' => ['type' => 'index', 'columns' => ['case_no'], 'length' => []],
            'structure_index' => ['type' => 'index', 'columns' => ['sd_section_structure_id'], 'length' => []],
