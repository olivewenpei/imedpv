...
class FieldsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'element_type_no' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'comment' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'Comment for field', 'precision' => null, 'fixed' => null],
        '_indexes' => [
            ...
            'element_type_number' => ['type' => 'index', 'columns' => ['element_type_no'], 'length' => []],
