...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $sdPhaseRoleSectionPermission->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $sdPhaseRoleSectionPermission->id)]
            )
        ?></li>
...
<div class="sdPhaseRoleSectionPermissions form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Sd Phase Role Section Permission') ?></legend>
        <?php
