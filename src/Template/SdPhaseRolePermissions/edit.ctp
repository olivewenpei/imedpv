...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $sdPhaseRolePermission->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $sdPhaseRolePermission->id)]
            )
        ?></li>
...
<div class="sdPhaseRolePermissions form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Sd Phase Role Permission') ?></legend>
        <?php
