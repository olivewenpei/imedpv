    ...
    public function general($caseId)
    {
        ...
        $sourceFields = $this->SdFieldValues->find('list', [
            ...
            ->where(function ($exp, $query) use($caseId){
                $section_strucutre_related = $exp->or_(['sd_field_id'=>'6'])->add(['sd_field_id'=>'362'])->add(['sd_field_id'=>'12'])->add(['sd_field_id'=>'363'])->add(['sd_field_id'=>'364'])->add(['sd_field_id'=>'365'])->add(['sd_field_id'=>'366']);
                return $exp->and_([
        ...
        $sdFields = $this->SdFields->find('list',[
            ...
            return $exp->or_(['id'=>'6'])->add(['id'=>'362'])->add(['id'=>'12'])->add(['id'=>'363'])->add(['id'=>'364'])->add(['id'=>'365'])->add(['id'=>'366']);
        })->toList();
        $sdFieldLookUps = $this->SdFieldValueLookUps->find('list',[
            ...
            return $exp->or_(['sd_field_id'=>'6'])->add(['sd_field_id'=>'362'])->add(['sd_field_id'=>'12'])->add(['sd_field_id'=>'363'])->add(['sd_field_id'=>'364'])->add(['sd_field_id'=>'365'])->add(['sd_field_id'=>'366']);
        })->toList();
